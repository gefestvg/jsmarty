...
//modifier transliterate and replace spaces
    jSmart.prototype.registerPlugin(
        'modifier',
        'translit_and_replace_spaces',
        function(s)
        {
            var tr = {
            "А" : "a", "Б" : "b", "В" : "v", "Г" : "g",
            ...
            "м" : "m", "н" : "n", "о" : "o", "п" : "p", "р" : "r",
            "с" : "s", "т" : "t", "у" : "u", "ф" : "f", "х" : "h",
            "ц" : "ts", "і" :"i", "І":"I", "ч" : "ch", "ш" : "sh",
            "щ" : "sch", "ъ" : "y", "ї" : "yi", "Ї" : "Yi", "є" : "ye", "Є":"Ye",
            "ы" : "yi", "ь" : "", "э" : "e", "ю" : "yu", "я" : "ya",
            " " : " ", "." : ".", "/" : "_"};
            return jSmart.prototype.PHPJS('strtr','translit_and_replace_spaces').strtr(jSmart.prototype.PHPJS('str_replace','translit_and_replace_spaces').str_replace([' ', '.', ','], ['_','',''], s.toLowerCase()),tr);
        }
    );
...
jSmart.prototype.registerPlugin(
    ...
    function(me, count)
    {
        return (me.length > count)?me.substring(0, count) + "..." : me;
    }
);
